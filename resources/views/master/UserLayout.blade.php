            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="index.html">
                  ...
                  <p>Rent<strong>Shop</strong> <span>Your Shopping Partner</span></p>
                </a>
                <!-- img based logo -->
              ...
              <div class="aa-cartbox">
                <a class="aa-cart-link" href="#">
                  ...
                  <span class="aa-cart-title">Rent CART</span>
                ...
                <div class="aa-cartbox-summary">
                  <ul>
                    ...
                    @foreach ($cartarray as $cart)
                      ...
                      <li>
                        <a class="aa-cartbox-img" href="#"><img src="{{ url('upload/'.$cart->product_img_path) }}" alt="img"></a>
                          <div class="aa-cartbox-info">
                            <h4><a href="#">{{ $cart->product_name }}</a></h4>
                            <p>
                              
                              <?php
                                $no = $cart->product_quantity;
                              ...
                              <form action="{{ url('cartupdate',$cart->cart_id) }}" method="post">
                                @csrf
                                <input type="number" min="1" max="<?php echo $no; ?>" value="<?php echo $qty; ?>" name="qty" style="width: 40px">
                        ...
                        <a class="aa-remove-product" href="{{ url('cartremove', $cart->cart_id) }}"><span class="fa fa-times"></span></a>
                      </li>

                        @php
                          $subtotal = $qty * $cart->product_cost;
                          $sum[] = $subtotal;
                          $total = array_sum($sum);
                        @endphp
