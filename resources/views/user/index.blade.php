                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                          <a class="aa-product-img" href="#"><img src="{{ url('upload/'.$product->product_img_path) }}" height="300" width="250" alt="polo shirt img"></a>
                          <a class="aa-add-card-btn"href="{{ url('addtocart', $product->product_id) }}"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                          ...
                          <a class="btn btn-success" href="{{ url('booking', $product->product_id.' '.$product->product_cost.' '.$product->product_quantity) }}">BOOK</a>
                          </div>
                        </li>
